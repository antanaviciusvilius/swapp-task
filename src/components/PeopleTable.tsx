    ...
    return (
        <div className={`overflow-y-auto overflow-x-hidden [&>*:nth-child(odd)]:bg-gray-900`}>
            ...
            {peopleList.length && peopleList.map((person, index) => {
                return (
                    <div key={person.name} className="grid grid-cols-[50px,_1fr] grid-flow-col md:grid-flow-row md:grid-cols-[50px_repeat(2,_minmax(0,_1fr))] p-2 md:p-8 bg-gray-700 text-white text-xl">
